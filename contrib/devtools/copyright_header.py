...
EXCLUDE = [
    # auto generated:
    'src/qt/bullshitbucksstrings.cpp',
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BullshitBucks developers'
...
Arguments:
    <base_directory> - The base directory of a bullshitbucks source code repository.
"""
