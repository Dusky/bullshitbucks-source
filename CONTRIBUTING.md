Contributing to BullshitBucks Core
============================

The BullshitBucks Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bullshitbucks-project/bullshitbucks/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BullshitBucks Core project, and is not to be
confused with overall BullshitBucks Network Protocol consensus changes.

Whether a pull request is merged into BullshitBucks Core rests with the project merge
...
Patches that change BullshitBucks consensus rules are considerably more involved than
...
Where a patchset proposes to change the BullshitBucks consensus, it must have been
...
The project leader is the release manager for each BullshitBucks Core release.
