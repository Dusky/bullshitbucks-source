...
from fake_stake.base_test import BullshitBucks_FakeStakeTest

class zBSBValidCoinSpendTest(BullshitBucks_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBSBs..." % DENOM_TO_USE)
