...
#ifndef BullshitBucks_ZBSBTRACKER_H
#define BullshitBucks_ZBSBTRACKER_H
...
public:
    CzBSBTracker(std::string strWalletFile);
    ~CzBSBTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBSBWallet* zBSBWallet = NULL);
...
#endif //BullshitBucks_ZBSBTRACKER_H
