...
#ifndef BullshitBucks_ZBSBWALLET_H
#define BullshitBucks_ZBSBWALLET_H
...
public:
    CzBSBWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBSB(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBSB(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //BullshitBucks_ZBSBWALLET_H
