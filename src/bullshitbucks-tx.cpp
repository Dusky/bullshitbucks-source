...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BullshitBucks Core bullshitbucks-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bullshitbucks-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bullshitbucks transaction") + "\n" +
                               "  bullshitbucks-tx [options] -create [commands]   " + _("Create hex-encoded bullshitbucks transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bullshitbucks transaction
