...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BullshitBucks server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "BullshitBucks server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BullshitBucks features */
        {"bullshitbucks", "listmasternodes", &listmasternodes, true, true, false},
        {"bullshitbucks", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bullshitbucks", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bullshitbucks", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bullshitbucks", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bullshitbucks", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bullshitbucks", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bullshitbucks", "masternodedebug", &masternodedebug, true, true, false},
        {"bullshitbucks", "startmasternode", &startmasternode, true, true, false},
        {"bullshitbucks", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bullshitbucks", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bullshitbucks", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bullshitbucks", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bullshitbucks", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bullshitbucks", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bullshitbucks", "preparebudget", &preparebudget, true, true, false},
        {"bullshitbucks", "submitbudget", &submitbudget, true, true, false},
        {"bullshitbucks", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bullshitbucks", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bullshitbucks", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bullshitbucks", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bullshitbucks", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bullshitbucks", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bullshitbucks", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bullshitbucks", "checkbudgets", &checkbudgets, true, true, false},
        {"bullshitbucks", "mnsync", &mnsync, true, true, false},
        {"bullshitbucks", "spork", &spork, true, true, false},
        {"bullshitbucks", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbsbseed", &getzbsbseed, false, false, true},
        {"zerocoin", "setzbsbseed", &setzbsbseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbsb", &searchdzbsb, false, false, true},
        {"zerocoin", "dzbsbstate", &dzbsbstate, false, false, true},
...
{
    return "> bullshitbucks-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:34801/\n";
}
