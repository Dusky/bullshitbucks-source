...
/* BullshitBucks GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BullshitBucks"
#define QAPP_ORG_DOMAIN "bullshitbucks.org"
#define QAPP_APP_NAME_DEFAULT "BullshitBucks-Qt"
#define QAPP_APP_NAME_TESTNET "BullshitBucks-Qt-testnet"
