...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BullshitBucks Core"),
     ...
     * override -datadir in the bullshitbucks.conf file in the default data directory
     * (to be consistent with bullshitbucksd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
