...
/** Utility functions used by the BullshitBucks Qt UI.
 */
namespace GUIUtil
{
...
// Render BullshitBucks addresses in monospace font
...
// Parse "bullshitbucks:" URI into recipient object, return true on successful parsing
