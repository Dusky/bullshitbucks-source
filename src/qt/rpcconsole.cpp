                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBSBPathCustom = GetArg("-zbsbbackuppath", "");
    ...
    if(!strzBSBPathCustom.empty()) {
        ui->wallet_customzbsbbackuppath->setText(QString::fromStdString(strzBSBPathCustom));
        ui->wallet_customzbsbbackuppath_label->setVisible(true);
        ui->wallet_customzbsbbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBSBPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BullshitBucks RPC console.") + "<br>" +
