...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::BSB);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeBullshitBucksAmount"))
        SoftSetArg("-anonymizebullshitbucksamount", settings.value("nAnonymizeBullshitBucksAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in bullshitbucks.cpp during shotdown to also remove the window positions
